...
set relativenumber 	"La distribucion de los numeros en linea son relativas
...
set encoding=utf-8	"Permite setear la codificacion de archivos para aceptar caracteres especiales
set sw=4		"La identacion es de 4 espacios
set nowrap		"El texto en una linea no baja a la siguiente, solo continua
